...
let tests =
  testList "Output parameter and return value tests" [
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended + "_unset_notPassed") [
        yield!
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended + "_unset_passedSome") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended + "_unset_passedNone") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended + "_set_notPassed") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended + "_set_passedSome") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended + "_set_passedNone") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValExtended_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption + "_unset_notPassed") [
        yield!
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption + "_unset_passedSome") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption + "_unset_passedSome_dto") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption + "_unset_passedNone") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption + "_unset_passedNone_dto") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption + "_set_passedSome") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption + "_set_passedSome_dto") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption + "_set_passedNone") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
      ...
      testList (nameof DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption + "_set_passedNone_dto") [
        yield!
          allNonResultExecuteMethods<DbGen.Procedures.dbo.ProcWithOutParamsAndRetValVoption_Executable, _>
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
          ...
          [
            ...
            yield!
              ...
              |> List.map (fun (name, exec) ->
                  ...
                  fun x ->
                    let res = exec x
                    {| res with Result = res.Result |> Seq.tryHead |}
              )
          ]
          |> List.map (fun (name, exec) ->
              testCase name <| fun () ->
