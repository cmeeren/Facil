...
let tests =
  testList "Nominal param DTO tests" [
    ...
    testCase (nameof DbGen.Procedures.dbo.ProcWithAllTypesNominalParams) <| fun () ->
    ...
    testCase (nameof DbGen.Procedures.dbo.ProcWithAllTypesNullNominalParams) <| fun () ->
    ...
    testCase (nameof DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNonNullNominalParams) <| fun () ->
    ...
    testCase (nameof DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNullNominalParams) <| fun () ->
    ...
    testCase (nameof DbGen.Scripts.TempTableAllTypesNonNullNominalParams) <| fun () ->
    ...
    testCase (nameof DbGen.Scripts.TempTableAllTypesNullNominalParams) <| fun () ->
