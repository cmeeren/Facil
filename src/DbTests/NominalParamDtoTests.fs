    ...
    testList "Nominal param DTO tests" [
        ...
        <| fun () ->
            ...
            DbGen
                .Procedures
                .dbo
                .ProcWithAllTypesNullNominalParams
                .WithConnection(Config.connStr)
                .WithParameters(dto)
                .Execute()
            |> ignore
        ...
        <| fun () ->
            ...
            DbGen
                .Procedures
                .dbo
                .ProcWithAllTypesFromTvpNonNullNominalParams
                .WithConnection(Config.connStr)
                .WithParameters(dto)
                .Execute()
            |> ignore
        ...
        <| fun () ->
            ...
            DbGen
                .Procedures
                .dbo
                .ProcWithAllTypesFromTvpNullNominalParams
                .WithConnection(Config.connStr)
                .WithParameters(dto)
                .Execute()
            |> ignore
        ...
        <| fun () ->
            ...
            DbGen
                .Scripts
                .TempTableAllTypesNonNullNominalParams
                .WithConnection(Config.connStr)
                .WithParameters(dto)
                .Execute()
            |> ignore
        ...
        <| fun () ->
            ...
            DbGen
                .Scripts
                .TempTableAllTypesNullNominalParams
                .WithConnection(Config.connStr)
                .WithParameters(dto)
                .Execute()
            |> ignore
