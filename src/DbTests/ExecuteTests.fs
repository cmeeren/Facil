...
let execTests =
  testList "Execute tests" [
    ...
    testList (nameof DbGen.Procedures.dbo.ProcSelectFromTableExtended) [
      yield!
        ...
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcSelectFromTableExtended
                  .WithConnection(Config.connStr)
                |> exec
              test <@ res.Value.TableCol1 = "test1" @>
              test <@ res.Value.TableCol2 = Some 1 @>
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithAllTypesNullExtended + "_allNull_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithAllTypesNullExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
            ...
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNonNull
                  ...
                  .WithParameters(
                    {|
                      Params = List.map DbGen.TableTypes.dbo.AllTypesNonNull.create [
                        {|
                          bigint = 1L
                          binary = Array.replicate 42 1uy
                          bit = true
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNonNullExtended + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNonNullExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
            ...
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNull
                  ...
                  .WithParameters(
                    {|
                      Params = List.map DbGen.TableTypes.dbo.AllTypesNull.create [
                        {|
                          bigint = Some 1L
                          binary = Some (Array.replicate 42 1uy)
                          bit = Some true
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNullExtended + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNullExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNull + "_allNull_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNull_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNullExtended + "_allNull_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithAllTypesFromTvpNullExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndNoParams) [
      yield!
        ...
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithMultipleColumnsAndNoParams
                  .WithConnection(Config.connStr)
                |> exec
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndNoParamsExtended) [
      yield!
        ...
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithMultipleColumnsAndNoParamsExtended
                  .WithConnection(Config.connStr)
                |> exec
              test <@ res.Value.Foo = 1 @>
              test <@ res.Value.Bar = "test" @>
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleDefaultParams + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleDefaultParams_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleDefaultParamsExtended + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleDefaultParamsExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNonDefaultParams + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNonDefaultParams_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNonDefaultParamsExtended + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNonDefaultParamsExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParams + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParams_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParamsExtended + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParamsExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParams + "_allNull") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParams_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParamsExtended + "_allNull") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParamsExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParams + "_allNull_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParams_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParamsExtended + "_allNull_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndSimpleNullParamsExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndTvpParams + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndTvpParams_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleColumnsAndTvpParamsExtended + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleColumnsAndTvpParamsExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              ...
              let res =
                DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParams
                  ...
                  .WithParameters(
                    ...
                    multi = [DbGen.TableTypes.dbo.MultiColNull.create (Foo = Some 1, Bar = Some "test")]
                  )
                |> exec
              test <@ res.Value.Foo = Some 1 @>
              test <@ res.Value.Bar = Some "test" @>
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParams + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParams_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParamsExtended + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParamsExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParams + "_allNull") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParams_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParamsExtended + "_allNull") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParamsExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParams + "_allNull_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParams_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParamsExtended + "_allNull_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithMultipleNullableColumnsAndTvpParamsExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithNonFSharpFriendlyNames) [
      yield!
        ...
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithNonFSharpFriendlyNames
                  .WithConnection(Config.connStr)
                |> exec
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithNonFSharpFriendlyNamesExtended) [
      yield!
        ...
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithNonFSharpFriendlyNamesExtended
                  .WithConnection(Config.connStr)
                |> exec
              test <@ res.Value.``This is the first column`` = "foo" @>
              test <@ res.Value.``!"#%&/()=?`` = 2 @>
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithSingleColumnAndNoParams) [
      yield!
        ...
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithSingleColumnAndNoParams
                  .WithConnection(Config.connStr)
                |> exec
              test <@ res.Value = 1 @>
        )
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithSingleColumnAndNoParamsExtended) [
      yield!
        ...
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithSingleColumnAndNoParamsExtended
                  .WithConnection(Config.connStr)
                |> exec
              test <@ res.Value = 1 @>
        )
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithSingleNamelessColumn) [
      yield!
        ...
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithSingleNamelessColumn
                  .WithConnection(Config.connStr)
                |> exec
              test <@ res.Value = 123 @>
        )
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithSingleNamelessColumnExtended) [
      yield!
        ...
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
              let res =
                DbGen.Procedures.dbo.ProcWithSingleNamelessColumnExtended
                  .WithConnection(Config.connStr)
                |> exec
              test <@ res.Value = 123 @>
        )
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithSingleNonNullColumnExtended + "_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithSingleNonNullColumnExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
    ...
    testList (nameof DbGen.Procedures.dbo.ProcWithSingleNullColumnExtended + "_null_paramsFromDto") [
      yield!
        allExecuteMethodsAsSingle<DbGen.Procedures.dbo.ProcWithSingleNullColumnExtended_Executable, _>
        |> List.map (fun (name, exec) ->
            testCase name <| fun () ->
