...
// Hash: fa0e16d0474962e28757a387a49be0bdf889bf751062347be40133c84010214a
...
module Procedures =
  ...
  module ``dbo`` =
    ...
    type ``ProcColumnInheritance`` private (connStr: string, conn: SqlConnection) =
      ...
      static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
        ``ProcColumnInheritance``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

      static member WithConnection(connection) = ``ProcColumnInheritance``(null, connection)
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcInsertInvalid_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =

      let configureCmd sqlParams (cmd: SqlCommand) =
        cmd.CommandType <- CommandType.StoredProcedure
        cmd.CommandText <- "dbo.ProcInsertInvalid"
    ...
    type ``ProcInsertInvalid`` private (connStr: string, conn: SqlConnection) =
      ...
      static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
        ``ProcInsertInvalid``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

      static member WithConnection(connection) = ``ProcInsertInvalid``(null, connection)
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@col2", SqlDbType.Int, Value = Option.toDbNull ``col2``)
          |]
        ``ProcInsertInvalid_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])

      member inline this.WithParameters(dto: ^a) =
        let getSqlParams () =
          [|
            SqlParameter("@col2", SqlDbType.Int, Value = Option.toDbNull (^a: (member ``Col2``: int option) dto))
          |]
        ``ProcInsertInvalid_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])


    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcOptionIn_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcOptionIn`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcOptionIn_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcOptionOut_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@param1", SqlDbType.NVarChar, Size = 50, Value = Option.toDbNull ``param1``)
          |]
        ``ProcOptionOut_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcOptionTvpInOut_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcOptionTvpInOut`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcOptionTvpInOut_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcVoptionIn_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcVoptionIn`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcVoptionIn_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcVoptionOut_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member _.ExecuteSingleAsync(?cancellationToken) =
        let sqlParams = getSqlParams ()
        executeQuerySingleAsyncVoption connStr conn configureConn (configureCmd sqlParams) initOrdinals getItem tempTableData (defaultArg cancellationToken CancellationToken.None)
      ...
      member _.ExecuteSingle() =
        let sqlParams = getSqlParams ()
        executeQuerySingleVoption connStr conn configureConn (configureCmd sqlParams) initOrdinals getItem tempTableData
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@param1", SqlDbType.NVarChar, Size = 50, Value = Option.toDbNull ``param1``)
          |]
        ``ProcVoptionOut_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcVoptionTvpInOut_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcVoptionTvpInOut`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcVoptionTvpInOut_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithAllTypes_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithAllTypes`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithAllTypes_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithAllTypesExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@xml", SqlDbType.Xml, Value = ``xml``)
          |]
        ``ProcWithAllTypesExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithAllTypesFromTvpNonNull_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithAllTypesFromTvpNonNull`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithAllTypesFromTvpNonNull_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithAllTypesFromTvpNonNullExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@params", SqlDbType.Structured, TypeName = "dbo.AllTypesNonNull", Value = boxNullIfEmpty ``params``)
          |]
        ``ProcWithAllTypesFromTvpNonNullExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithAllTypesFromTvpNull_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithAllTypesFromTvpNull`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithAllTypesFromTvpNull_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithAllTypesFromTvpNullExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@params", SqlDbType.Structured, TypeName = "dbo.AllTypesNull", Value = boxNullIfEmpty ``params``)
          |]
        ``ProcWithAllTypesFromTvpNullExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithAllTypesNull_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithAllTypesNull`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithAllTypesNull_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithAllTypesNullExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@xml", SqlDbType.Xml, Value = Option.toDbNull ``xml``)
          |]
        ``ProcWithAllTypesNullExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    type ``ProcWithCamelCaseColNames`` private (connStr: string, conn: SqlConnection) =
      ...
      static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
        ``ProcWithCamelCaseColNames``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

      static member WithConnection(connection) = ``ProcWithCamelCaseColNames``(null, connection)
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithDynamicSqlWithFullTextSearch_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithDynamicSqlWithFullTextSearch`` private (connStr: string, conn: SqlConnection) =
      ...
      static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
        ``ProcWithDynamicSqlWithFullTextSearch``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

      static member WithConnection(connection) = ``ProcWithDynamicSqlWithFullTextSearch``(null, connection)
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithDynamicSqlWithFullTextSearch_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithLengthTypes_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithLengthTypes`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithLengthTypes_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithLengthTypesFromTvp_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithLengthTypesFromTvp`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithLengthTypesFromTvp_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMaxLengthTypes_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithMaxLengthTypes`` private (connStr: string, conn: SqlConnection) =
      ...
      static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
        ``ProcWithMaxLengthTypes``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

      static member WithConnection(connection) = ``ProcWithMaxLengthTypes``(null, connection)
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithMaxLengthTypes_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMaxLengthTypesFromTvp_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithMaxLengthTypesFromTvp`` private (connStr: string, conn: SqlConnection) =
      ...
      static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
        ``ProcWithMaxLengthTypesFromTvp``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

      static member WithConnection(connection) = ``ProcWithMaxLengthTypesFromTvp``(null, connection)
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithMaxLengthTypesFromTvp_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleColumnsAndSimpleDefaultParams_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithMultipleColumnsAndSimpleDefaultParams`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithMultipleColumnsAndSimpleDefaultParams_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleColumnsAndSimpleDefaultParamsExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@bar", SqlDbType.NVarChar, Size = 50, Value = ``bar``)
          |]
        ``ProcWithMultipleColumnsAndSimpleDefaultParamsExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleColumnsAndSimpleNonDefaultParams_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@bar", SqlDbType.NVarChar, Size = 50, Value = ``bar``)
          |]
        ``ProcWithMultipleColumnsAndSimpleNonDefaultParams_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleColumnsAndSimpleNonDefaultParamsExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@bar", SqlDbType.NVarChar, Size = 50, Value = ``bar``)
          |]
        ``ProcWithMultipleColumnsAndSimpleNonDefaultParamsExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleColumnsAndSimpleNullParams_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithMultipleColumnsAndSimpleNullParams`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithMultipleColumnsAndSimpleNullParams_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleColumnsAndSimpleNullParamsExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@bar", SqlDbType.NVarChar, Size = 50, Value = Option.toDbNull ``bar``)
          |]
        ``ProcWithMultipleColumnsAndSimpleNullParamsExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleColumnsAndTvpParams_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithMultipleColumnsAndTvpParams`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithMultipleColumnsAndTvpParams_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleColumnsAndTvpParamsExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@multi", SqlDbType.Structured, TypeName = "dbo.MultiColNonNull", Value = boxNullIfEmpty ``multi``)
          |]
        ``ProcWithMultipleColumnsAndTvpParamsExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleNullableColumnsAndTvpParams_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithMultipleNullableColumnsAndTvpParams`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithMultipleNullableColumnsAndTvpParams_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMultipleNullableColumnsAndTvpParamsExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@multi", SqlDbType.Structured, TypeName = "dbo.MultiColNull", Value = boxNullIfEmpty ``multi``)
          |]
        ``ProcWithMultipleNullableColumnsAndTvpParamsExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithNoResults_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@foo", SqlDbType.Int, Value = ``foo``)
          |]
        ``ProcWithNoResults_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithNoResultsExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@foo", SqlDbType.Int, Value = ``foo``)
          |]
        ``ProcWithNoResultsExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithOutParams_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithOutParams`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithOutParams_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithOutParamsAndRetVal_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithOutParamsAndRetVal`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithOutParamsAndRetVal_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithOutParamsAndRetValExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("ReturnValue", SqlDbType.Int, Direction = ParameterDirection.ReturnValue)
          |]
        ``ProcWithOutParamsAndRetValExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithOutParamsAndRetValVoption_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("ReturnValue", SqlDbType.Int, Direction = ParameterDirection.ReturnValue)
          |]
        ``ProcWithOutParamsAndRetValVoption_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithOutParamsExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@out2", SqlDbType.NVarChar, Size = 50, Direction = ParameterDirection.InputOutput, Value = (``out2`` |> Option.map Option.toDbNull |> Option.defaultValue (box DBNull.Value)))
          |]
        ``ProcWithOutParamsExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithOverriddenDtoParamName_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithOverriddenDtoParamName`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithOverriddenDtoParamName_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithResultsAndOutParams_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@out2", SqlDbType.NVarChar, Size = 50, Direction = ParameterDirection.InputOutput, Value = (``out2`` |> Option.map Option.toDbNull |> Option.defaultValue (box DBNull.Value)))
          |]
        ``ProcWithResultsAndOutParams_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithResultsAndOutParamsAndRetVal_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("ReturnValue", SqlDbType.Int, Direction = ParameterDirection.ReturnValue)
          |]
        ``ProcWithResultsAndOutParamsAndRetVal_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithResultsAndOutParamsAndRetValExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("ReturnValue", SqlDbType.Int, Direction = ParameterDirection.ReturnValue)
          |]
        ``ProcWithResultsAndOutParamsAndRetValExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithResultsAndOutParamsExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@out2", SqlDbType.NVarChar, Size = 50, Direction = ParameterDirection.InputOutput, Value = (``out2`` |> Option.map Option.toDbNull |> Option.defaultValue (box DBNull.Value)))
          |]
        ``ProcWithResultsAndOutParamsExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithResultsAndRetVal_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("ReturnValue", SqlDbType.Int, Direction = ParameterDirection.ReturnValue)
          |]
        ``ProcWithResultsAndRetVal_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithResultsAndRetValExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("ReturnValue", SqlDbType.Int, Direction = ParameterDirection.ReturnValue)
          |]
        ``ProcWithResultsAndRetValExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithRetVal_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("ReturnValue", SqlDbType.Int, Direction = ParameterDirection.ReturnValue)
          |]
        ``ProcWithRetVal_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithRetValExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("ReturnValue", SqlDbType.Int, Direction = ParameterDirection.ReturnValue)
          |]
        ``ProcWithRetValExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithSingleNonNullColumn_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@foo", SqlDbType.Int, Value = ``foo``)
          |]
        ``ProcWithSingleNonNullColumn_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithSingleNonNullColumnExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@foo", SqlDbType.Int, Value = ``foo``)
          |]
        ``ProcWithSingleNonNullColumnExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithSingleNullColumn_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@foo", SqlDbType.Int, Value = Option.toDbNull ``foo``)
          |]
        ``ProcWithSingleNullColumn_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithSingleNullColumnExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            SqlParameter("@foo", SqlDbType.Int, Value = Option.toDbNull ``foo``)
          |]
        ``ProcWithSingleNullColumnExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithSpecialCasing_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithSpecialCasing`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          ...
          |]
        ``ProcWithSpecialCasing_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithSpecialCasingExtended_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
      ...
      member this.WithParameters
        ...
        let getSqlParams () =
          [|
            ...
            SqlParameter("@param3", SqlDbType.Int, Value = ``param3``)
          |]
        ``ProcWithSpecialCasingExtended_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
...
module Scripts =
  ...
  type ``ColumnInheritance`` private (connStr: string, conn: SqlConnection) =
    ...
    static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
      ``ColumnInheritance``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

    static member WithConnection(connection) = ``ColumnInheritance``(null, connection)
  ...
  type ``DynamicSqlSensitiveToParamValues`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        ...
        |]
      ``DynamicSqlSensitiveToParamValues_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``DynamicSqlSensitiveToParamValuesWithResultSets_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        [|
          SqlParameter("@orderBy", SqlDbType.NVarChar, Size = 0, Value = ``orderBy``)
        |]
      ``DynamicSqlSensitiveToParamValuesWithResultSets_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  type ``DynamicSqlWithConflictingBranches`` private (connStr: string, conn: SqlConnection) =
    ...
    static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
      ``DynamicSqlWithConflictingBranches``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

    static member WithConnection(connection) = ``DynamicSqlWithConflictingBranches``(null, connection)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``DynamicSqlWithDeclaration_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``DynamicSqlWithDeclaration`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        ...
        |]
      ``DynamicSqlWithDeclaration_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``DynamicSqlWithoutDeclaration_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        [|
          SqlParameter("@col1Filter", SqlDbType.NVarChar, Size = 42, Value = ``col1Filter``)
        |]
      ``DynamicSqlWithoutDeclaration_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``DynamicSqlWithStringSplitParam_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``DynamicSqlWithStringSplitParam`` private (connStr: string, conn: SqlConnection) =
    ...
    static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
      ``DynamicSqlWithStringSplitParam``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

    static member WithConnection(connection) = ``DynamicSqlWithStringSplitParam``(null, connection)
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        ...
        |]
      ``DynamicSqlWithStringSplitParam_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``DynamicSqlWithTvp_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``DynamicSqlWithTvp`` private (connStr: string, conn: SqlConnection) =
    ...
    static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
      ``DynamicSqlWithTvp``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

    static member WithConnection(connection) = ``DynamicSqlWithTvp``(null, connection)
  ...
  type ``MultipleTempTables`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      ``MultipleTempTables_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, tempTableData)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``NormalParams_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``NormalParams`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        ...
        |]
      ``NormalParams_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``OptionRecompileAndFetch_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``OptionRecompileAndFetch`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        ...
        |]
      ``OptionRecompileAndFetch_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``OverriddenDtoParamName_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        [|
          SqlParameter("@nameToBeOverridden", SqlDbType.Int, Value = ``nameToBeOverridden``)
        |]
      ``OverriddenDtoParamName_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``ParamInheritance_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``ParamInheritance`` private (connStr: string, conn: SqlConnection) =
    ...
    static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
      ``ParamInheritance``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

    static member WithConnection(connection) = ``ParamInheritance``(null, connection)
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        ...
        |]
      ``ParamInheritance_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``ParamsUsedTwice_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``ParamsUsedTwice`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        ...
        |]
      ``ParamsUsedTwice_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``TempTableAllTypesNonNull_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``TempTableAllTypesNonNull`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      ``TempTableAllTypesNonNull_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, tempTableData)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``TempTableAllTypesNull_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``TempTableAllTypesNull`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      ``TempTableAllTypesNull_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, tempTableData)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``TempTableAllTypesNullVoption_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``TempTableAllTypesNullVoption`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      ``TempTableAllTypesNullVoption_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, tempTableData)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``TempTableInlined_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``TempTableInlined`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      ``TempTableInlined_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, tempTableData)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``TempTableInlinedDynamic_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``TempTableInlinedDynamic`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      ``TempTableInlinedDynamic_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, tempTableData)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``TempTableInlinedWithOtherParams_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``TempTableInlinedWithOtherParams`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      ``TempTableInlinedWithOtherParams_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, tempTableData)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``TempTableWithLengthTypes_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``TempTableWithLengthTypes`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      ``TempTableWithLengthTypes_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, tempTableData)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``TempTableWithMaxLengthTypes_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``TempTableWithMaxLengthTypes`` private (connStr: string, conn: SqlConnection) =
    ...
    static member WithConnection(connectionString, ?configureConnection: SqlConnection -> unit) =
      ``TempTableWithMaxLengthTypes``(connectionString, null).ConfigureConnection(?configureConnection=configureConnection)

    static member WithConnection(connection) = ``TempTableWithMaxLengthTypes``(null, connection)
    ...
    member this.WithParameters
      ...
      ``TempTableWithMaxLengthTypes_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, tempTableData)
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``UserDefinedTableType_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    member this.WithParameters
      ...
      let getSqlParams () =
        [|
          SqlParameter("@tvp", SqlDbType.Structured, TypeName = "dbo.MultiColNull", Value = boxNullIfEmpty ``tvp``)
        |]
      ``UserDefinedTableType_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
  ...
  module ``Option`` =
      ...
      [<EditorBrowsable(EditorBrowsableState.Never)>]
      type ``In_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
        ...
        member this.WithParameters
          ...
          let getSqlParams () =
            [|
              SqlParameter("@param1", SqlDbType.NVarChar, Size = 50, Value = Option.toDbNull ``param1``)
            |]
          ``In_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
      ...
      [<EditorBrowsable(EditorBrowsableState.Never)>]
      type ``Out_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
        ...
        member this.WithParameters
          ...
          let getSqlParams () =
            [|
              SqlParameter("@param1", SqlDbType.NVarChar, Size = 50, Value = Option.toDbNull ``param1``)
            |]
          ``Out_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
      ...
      [<EditorBrowsable(EditorBrowsableState.Never)>]
      type ``TvpInOut_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, getSqlParams: unit -> SqlParameter [], tempTableData: seq<TempTableData>) =
        ...
        member this.WithParameters
          ...
          let getSqlParams () =
            [|
              SqlParameter("@tvp", SqlDbType.Structured, TypeName = "dbo.MultiColNull", Value = boxNullIfEmpty ``tvp``)
            |]
          ``TvpInOut_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, getSqlParams, [])
