...
// Hash: 08d0de19ae1d8e667746fd48b15b58509d032574bc173ce67b02dbc727df0366
...
module Procedures =
  ...
  module ``dbo`` =
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithDynamicSqlWithFullTextSearch_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, sqlParams: SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithDynamicSqlWithFullTextSearch`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let sqlParams =
          ...
          |]
        ``ProcWithDynamicSqlWithFullTextSearch_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMaxLengthTypes_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, sqlParams: SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithMaxLengthTypes`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let sqlParams =
          ...
          |]
        ``ProcWithMaxLengthTypes_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, [])
    ...
    [<EditorBrowsable(EditorBrowsableState.Never)>]
    type ``ProcWithMaxLengthTypesFromTvp_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, sqlParams: SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    type ``ProcWithMaxLengthTypesFromTvp`` private (connStr: string, conn: SqlConnection) =
      ...
      member this.WithParameters
        ...
        let sqlParams =
          [|
            SqlParameter("@tvp", SqlDbType.Structured, TypeName = "dbo.MaxLengthTypes", Value = ``tvp``)
          |]
        ``ProcWithMaxLengthTypesFromTvp_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, [])

      member inline this.WithParameters(dto: ^a) =
        let sqlParams =
          [|
            SqlParameter("@tvp", SqlDbType.Structured, TypeName = "dbo.MaxLengthTypes", Value = (^a: (member ``Tvp``: #seq<TableTypes.``dbo``.``MaxLengthTypes``>) dto))
          |]
        ``ProcWithMaxLengthTypesFromTvp_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, [])
...
module Scripts =
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``DynamicSqlWithStringSplitParam_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, sqlParams: SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``DynamicSqlWithStringSplitParam`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      let sqlParams =
        ...
        |]
      ``DynamicSqlWithStringSplitParam_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``DynamicSqlWithTvp_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, sqlParams: SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``DynamicSqlWithTvp`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      let sqlParams =
        [|
          SqlParameter("@tvp", SqlDbType.Structured, TypeName = "dbo.SingleColNonNull", Value = ``tvp``)
        |]
      ``DynamicSqlWithTvp_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, [])

    member inline this.WithParameters(dto: ^a) =
      let sqlParams =
        [|
          SqlParameter("@tvp", SqlDbType.Structured, TypeName = "dbo.SingleColNonNull", Value = (^a: (member ``Tvp``: #seq<TableTypes.``dbo``.``SingleColNonNull``>) dto))
        |]
      ``DynamicSqlWithTvp_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``ParamInheritance_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, sqlParams: SqlParameter [], tempTableData: seq<TempTableData>) =
    ...
    member this.WithParameters
      ...
      let sqlParams =
        [|
          ...
          SqlParameter("@col2", SqlDbType.Int, Value = ``col2``)
        |]
      ``ParamInheritance_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, [])

    member inline this.WithParameters(dto: ^a) =
      let sqlParams =
        [|
          SqlParameter("@col1", SqlDbType.Int, Value = Option.toDbNull (^a: (member ``Col1``: int option) dto))
          SqlParameter("@col2", SqlDbType.Int, Value = (^a: (member ``Col2``: int) dto))
        |]
      ``ParamInheritance_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, [])
  ...
  [<EditorBrowsable(EditorBrowsableState.Never)>]
  type ``TempTableWithMaxLengthTypes_Executable`` (connStr: string, conn: SqlConnection, configureConn: SqlConnection -> unit, userConfigureCmd: SqlCommand -> unit, sqlParams: SqlParameter [], tempTableData: seq<TempTableData>) =
  ...
  type ``TempTableWithMaxLengthTypes`` private (connStr: string, conn: SqlConnection) =
    ...
    member this.WithParameters
      ...
      ``TempTableWithMaxLengthTypes_Executable``(this.connStr, this.conn, this.configureConn, this.userConfigureCmd, sqlParams, tempTableData)
